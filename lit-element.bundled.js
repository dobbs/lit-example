...
/**
* Experiment to remove the need to build.
*
* curl -L https://github.com/PolymerLabs/lit-element-starter-js/archive/master.zip > lit-element-starter-js-master.zip
* unzip lit-element-starter-js-master.zip
* cd lit-element-starter-js-master
* npm install
* npm run docs
* cp docs/my-element.bundled.js lit-element.bundled.js
*
* hackity-hack to replace the example my-element with this simple export
*/
export {
  X as LitElement,
  K as css,
